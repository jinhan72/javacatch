...
<ol>
	<li><a href="control.jsp?action=main"><img alt="로고" src="img/tmIcon.png" style="width:30px;height:30px;"></a></li>
...
<ol>
	<c:forEach var="u" items="${newUsers}">
		<li><a href="control.jsp?action=main&mcnt=${mcnt}&selUser=${u.uid}">${u.name}</a>님 가입</li>
	</c:forEach>
</ol>
